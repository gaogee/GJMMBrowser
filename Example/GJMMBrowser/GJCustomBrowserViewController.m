//
//  GJCustomBrowserViewController.m
//  GJMMBrowser_Example
//
...
#import "GJCustomBrowserViewController.h"
#import "GJMMBrowser.h"
#import "GJCustomFooterContentView.h"
@interface GJCustomBrowserViewController ()<UICollectionViewDelegate, UICollectionViewDataSource,GJMultiMediaBrowserDelegate>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) NSArray *resoucres;
@property (nonatomic, strong) GJMMBrowser *mBrowser;
@end

@implementation GJCustomBrowserViewController
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:GJCustomBrowserViewCell.class forCellWithReuseIdentifier:NSStringFromClass(GJCustomBrowserViewCell.class)];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    GJCustomBrowserViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(GJCustomBrowserViewCell.class) forIndexPath:indexPath];
...
@implementation GJCustomBrowserViewCell
